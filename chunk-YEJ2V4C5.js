...
__name(ContactComponent_div_11_Template, "ContactComponent_div_11_Template");
function ContactComponent_div_19_span_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1, "Email jest wymagany.");
    \u0275\u0275elementEnd();
  }
}
__name(ContactComponent_div_19_span_1_Template, "ContactComponent_div_19_span_1_Template");
function ContactComponent_div_19_span_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1, "Wprowad\u017A poprawny adres email.");
    \u0275\u0275elementEnd();
  }
}
__name(ContactComponent_div_19_span_2_Template, "ContactComponent_div_19_span_2_Template");
function ContactComponent_div_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 18);
    \u0275\u0275template(1, ContactComponent_div_19_span_1_Template, 2, 0, "span", 19)(2, ContactComponent_div_19_span_2_Template, 2, 0, "span", 19);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275nextContext();
    const email_r3 = \u0275\u0275reference(18);
    \u0275\u0275advance();
...
__name(ContactComponent_div_19_Template, "ContactComponent_div_19_Template");
function ContactComponent_div_24_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 18);
    \u0275\u0275text(1, " Wiadomo\u015B\u0107 jest wymagana. ");
    \u0275\u0275elementEnd();
  }
}
__name(ContactComponent_div_24_Template, "ContactComponent_div_24_Template");
function ContactComponent_div_29_a_2_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const link_r4 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275property("href", link_r4.url, \u0275\u0275sanitizeUrl);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(link_r4.url);
  }
}
__name(ContactComponent_div_29_a_2_Template, "ContactComponent_div_29_a_2_Template");
function ContactComponent_div_29_span_3_Template(rf, ctx) {
  if (rf & 1) {
...
__name(ContactComponent_div_29_span_3_Template, "ContactComponent_div_29_span_3_Template");
function ContactComponent_div_29_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 20);
    \u0275\u0275element(1, "ng-icon", 21);
    \u0275\u0275template(2, ContactComponent_div_29_a_2_Template, 2, 2, "a", 22)(3, ContactComponent_div_29_span_3_Template, 2, 1, "span", 23);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const link_r4 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("name", link_r4.name);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", link_r4.name !== "svglGmail");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", link_r4.name === "svglGmail");
  }
}
__name(ContactComponent_div_29_Template, "ContactComponent_div_29_Template");
var _ContactComponent = class _ContactComponent {
  ...
  onSubmit(form) {
    if (form.controls["message"].value === "" || form.controls["email"].value === "" || form.controls["name"].value === "" || !form.controls["email"].valid) {
    ...
    this.http.post(url, form.value).subscribe({
      ...
      error: /* @__PURE__ */ __name(() => alert("B\u0142\u0105d wysy\u0142ki"), "error")
    });
  }
};
__name(_ContactComponent, "ContactComponent");
__publicField(_ContactComponent, "\u0275fac", /* @__PURE__ */ __name(function ContactComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _ContactComponent)(\u0275\u0275directiveInject(HttpClient));
}, "ContactComponent_Factory"));
__publicField(_ContactComponent, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ContactComponent, selectors: [["app-contact"]], features: [\u0275\u0275ProvidersFeature([
  provideIcons({
    svglGithubDark,
    svglLinkedin,
    svglGmail
  })
])], decls: 30, vars: 4, consts: [["contactForm", "ngForm"], ["firstName", "ngModel"], ["email", "ngModel"], ["message", "ngModel"], [1, "contact"], [1, "contact__title"], [1, "contact__form", 3, "ngSubmit"], ["for", "firstName"], ["type", "text", "id", "firstName", "name", "firstName", "ngModel", "", "required", ""], ["class", "error", 4, "ngIf"], ["for", "lastName"], ["type", "text", "id", "lastName", "name", "lastName", "ngModel", ""], ["for", "email"], ["type", "email", "id", "email", "name", "email", "ngModel", "", "required", "", "email", ""], ["for", "message"], ["id", "message", "name", "message", "rows", "5", "ngModel", "", "required", ""], ["type", "submit"], ["class", "contact__link", 4, "ngFor", "ngForOf"], [1, "error"], [4, "ngIf"], [1, "contact__link"], [1, "contact__link__icon", 3, "name"], ["class", "contact__link__url", 3, "href", 4, "ngIf"], ["class", "contact__link__url contact__link__url__mail", 4, "ngIf"], [1, "contact__link__url", 3, "href"], [1, "contact__link__url", "contact__link__url__mail"]], template: /* @__PURE__ */ __name(function ContactComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "h2");
    \u0275\u0275text(4, "Napisz do mnie");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "form", 6, 0);
    \u0275\u0275listener("ngSubmit", /* @__PURE__ */ __name(function ContactComponent_Template_form_ngSubmit_5_listener() {
      \u0275\u0275restoreView(_r1);
      const contactForm_r2 = \u0275\u0275reference(6);
      return \u0275\u0275resetView(ctx.onSubmit(contactForm_r2));
    }, "ContactComponent_Template_form_ngSubmit_5_listener"));
    \u0275\u0275elementStart(7, "label", 7);
    \u0275\u0275text(8, "*Imi\u0119:");
    \u0275\u0275elementEnd();
    \u0275\u0275element(9, "input", 8, 1);
    \u0275\u0275template(11, ContactComponent_div_11_Template, 2, 0, "div", 9);
    ...
    \u0275\u0275text(16, "*Email:");
    \u0275\u0275elementEnd();
    \u0275\u0275element(17, "input", 13, 2);
    \u0275\u0275template(19, ContactComponent_div_19_Template, 3, 2, "div", 9);
    \u0275\u0275elementStart(20, "label", 14);
    \u0275\u0275text(21, "*Wiadomo\u015B\u0107:");
    \u0275\u0275elementEnd();
    \u0275\u0275element(22, "textarea", 15, 3);
    \u0275\u0275template(24, ContactComponent_div_24_Template, 2, 0, "div", 9);
    \u0275\u0275elementStart(25, "button", 16);
    \u0275\u0275text(26, "Wy\u015Blij");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "span");
    \u0275\u0275text(28, "* - Pola wymagane");
    \u0275\u0275elementEnd()();
    \u0275\u0275template(29, ContactComponent_div_29_Template, 4, 3, "div", 17);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const firstName_r5 = \u0275\u0275reference(10);
    const email_r3 = \u0275\u0275reference(18);
    const message_r6 = \u0275\u0275reference(23);
    \u0275\u0275advance(11);
    \u0275\u0275property("ngIf", firstName_r5.invalid && firstName_r5.touched);
    \u0275\u0275advance(8);
...
@angular/forms/fesm2022/forms.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-YEJ2V4C5.js.map
