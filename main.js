...
var VERSION2 = new Version("20.3.0");
...
var _AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const loadFn = /* @__PURE__ */ __name(() => this.moduleImpl ?? import("./chunk-OZR5CUDH.js").then((m) => m), "loadFn");
...
var routes = [
  {
    path: "about",
    loadComponent: /* @__PURE__ */ __name(() => import("./chunk-INETOGED.js").then((m) => m.AboutComponent), "loadComponent"),
    data: { animation: "AboutPage" }
  },
  {
    path: "skills",
    loadComponent: /* @__PURE__ */ __name(() => import("./chunk-P4RK4C3X.js").then((m) => m.SkillsComponent), "loadComponent"),
    data: { animation: "SkillsPage" }
  },
  {
    path: "projects",
    loadComponent: /* @__PURE__ */ __name(() => import("./chunk-ADYRZR5R.js").then((m) => m.ProjectsComponent), "loadComponent"),
    data: { animation: "ProjectsPage" }
  },
  {
    path: "contact",
    loadComponent: /* @__PURE__ */ __name(() => import("./chunk-YEJ2V4C5.js").then((m) => m.ContactComponent), "loadComponent"),
...
__publicField(_HeaderComponent, "\u0275fac", /* @__PURE__ */ __name(function HeaderComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _HeaderComponent)();
}, "HeaderComponent_Factory"));
__publicField(_HeaderComponent, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HeaderComponent, selectors: [["app-header"]], decls: 10, vars: 0, consts: [[1, "nav"], [1, "nav__items"], ["routerLink", "about", "routerLinkActive", "active", 1, "nav__items__item"], ["routerLink", "skills", "routerLinkActive", "active", 1, "nav__items__item"], ["routerLink", "projects", "routerLinkActive", "active", 1, "nav__items__item"], ["routerLink", "contact", "routerLinkActive", "active", 1, "nav__items__item"]], template: /* @__PURE__ */ __name(function HeaderComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "a", 2);
    \u0275\u0275text(3, "O mnie");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "a", 3);
    \u0275\u0275text(5, "Umiej\u0119tno\u015Bci");
    \u0275\u0275elementEnd();
...
__publicField(_App, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({ type: _App, selectors: [["app-root"]], decls: 5, vars: 1, consts: [["o", "outlet"], [1, "app"], [1, "app__content"]], template: /* @__PURE__ */ __name(function App_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const o_r1 = \u0275\u0275reference(4);
    \u0275\u0275advance(2);
    \u0275\u0275property("@routeAnimations", o_r1 == null ? null : o_r1.activatedRouteData == null ? null : o_r1.activatedRouteData["animation"]);
  }
}, "App_Template"), dependencies: [HeaderComponent, RouterModule, RouterOutlet], styles: ["\n\n.app[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n}\n.app__content[_ngcontent-%COMP%] {\n  position: relative;\n  height: 100%;\n}\n/*# sourceMappingURL=app.css.map */"], data: { animation: [
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(App, [{
    type: Component,
    args: [{ selector: "app-root", standalone: true, imports: [HeaderComponent, RouterModule], animations: [
      trigger("routeAnimations", [
        transition("* <=> *", [
          query(":enter, :leave", [
            style({ position: "absolute", width: "100%", top: 0, left: 0 })
    ...
    ], template: `<div class="app">\r
  <app-header></app-header>\r
  <main class="app__content" [@routeAnimations]="o?.activatedRouteData?.['animation']">\r
    <router-outlet #o="outlet"></router-outlet>\r
  </main>\r
</div>\r
